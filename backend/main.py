...
from app.api import admin, auth, filters, ivan_alt_local_routes, posts, reviews, route_builder, social, trips, uploads, user, travel
...
api_router.include_router(route_builder.router, tags=["Route Builder"])
